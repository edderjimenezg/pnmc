...
export class SchoolsPageComponent implements OnInit {
  ...
  readonly hasFilters = computed(() => Boolean(this.search() || this.department() || this.municipality()));
