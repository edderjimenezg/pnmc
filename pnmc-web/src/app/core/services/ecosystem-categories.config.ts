...
export const ECOSYSTEM_CATEGORIES: EcosystemCategory[] = [
  ...
  { title: 'Festivales', route: 'simus/festivales', layer: 'Festivales', description: 'Celebraciones, encuentros y circuitos de circulación.', status: 'Disponible', icon: 'festivals', countKey: 'festivals', group: 'processes' },
